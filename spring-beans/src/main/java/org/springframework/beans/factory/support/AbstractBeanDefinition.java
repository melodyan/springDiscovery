...
public abstract class AbstractBeanDefinition extends BeanMetadataAttributeAccessor
	...
	/**
	 * 用来表示一个bean的实例化依靠另一个bean的先实例化，对应的bean属性为depend-on
	 */
	@Nullable
	private String[] dependsOn;

	/**
	 * autowire-candidate属性设置为false，这样容器在查找自动装配对象时，将不考虑该bean，即他不会被考虑为其他bean自动装配的候选者，但是该bean本身还是可以使用自动装配来注入其他bean的
	...
	/**
	 * 用于记录Qualifier，对应的子元素为qualifier
	 */
